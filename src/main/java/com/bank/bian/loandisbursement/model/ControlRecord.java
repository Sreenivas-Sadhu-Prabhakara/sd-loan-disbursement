package com.bank.bian.loandisbursement.model;
...
/**
 * The BIAN control record for this service domain: "Disbursement Instruction Procedure".
 *
 ...
 * to its asset type (Disbursement Instruction). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Disbursement Instruction Procedure";
